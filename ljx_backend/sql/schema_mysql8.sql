...
CREATE TABLE `user` (
  ...
  `user_type` TINYINT DEFAULT 0 COMMENT '用户类型：0普通用户 1传承人 2管理员',
...
CREATE TABLE `like_record` (
  ...
  `target_type` TINYINT NOT NULL COMMENT '点赞目标类型：1文章 2帖子',
...
CREATE TABLE `comment` (
  ...
  `target_type` TINYINT NOT NULL COMMENT '评论目标类型：1文章 2帖子',
...
CREATE TABLE `follow` (
  `follow_id` INT NOT NULL AUTO_INCREMENT COMMENT '关注ID，主键',
...
CREATE TABLE `footprint` (
  `footprint_id` INT NOT NULL AUTO_INCREMENT COMMENT '足迹ID，主键',
  `user_id` INT NOT NULL COMMENT '用户ID',
  `article_id` INT NOT NULL COMMENT '文章ID',
...
CREATE TABLE `course` (
  ...
  `category_id` INT NOT NULL COMMENT '所属分类ID',
  `user_id` INT NOT NULL COMMENT '讲师用户ID',
...
CREATE TABLE `course_download` (
  `download_id` INT NOT NULL AUTO_INCREMENT COMMENT '下载ID，主键',
  `user_id` INT NOT NULL COMMENT '用户ID',
...
CREATE TABLE `user_work` (
  `work_id` INT NOT NULL AUTO_INCREMENT COMMENT '作品ID，主键',
  `user_id` INT NOT NULL COMMENT '用户ID',
